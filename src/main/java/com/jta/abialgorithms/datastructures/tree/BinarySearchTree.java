package com.jta.abialgorithms.datastructures.tree;
...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
   ...
   *
   * @param pContent einzufuegendes Objekt vom Typ ContentType
   */
   ...
   * nichts.
   *
   * @param pContent zu entfernendes Objekt vom Typ ContentType
   */
   ...
   *
   * @param pContent zu suchendes Objekt vom Typ ContentType
